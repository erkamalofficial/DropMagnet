              ...
              >
                ...
                <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                  <div style={{display: 'flex', paddingBottom: '12px'}}>
                    ...
                    <img width={174} height={174} style={{borderRadius: '3px', 
                         objectFit: 'cover', 
                         objectPosition: '50% 0%'}} src={props.drops[1].drop_image} />
                  </div>
                  <div style={{display: 'flex'}}>
                    <img width={174} height={174} style={{borderRadius: '3px', 
                         paddingRight: '12px', 
                         objectFit: 'cover', 
                         objectPosition: '50% 0%'}} src={props.drops[2].drop_image} />
                    <img width={174} height={174} style={{borderRadius: '3px', 
                         objectFit: 'cover', 
                         objectPosition: '50% 0%'}} src={props.drops[3].drop_image} />
                  </div>
                </div>
