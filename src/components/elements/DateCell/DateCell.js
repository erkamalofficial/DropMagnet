...
import { epochToDayMonth, formatDate } from "../../../helpers/DateFormatter";
  ...
  function renderDate() {
    return <div className="date-cell-style" style={props.cellSelected ? {background: '#E2E5E7'} : {}} onClick={() => props.setSelectedDate(props.day)}>
      <div style={{display: 'flex', justifyContent: 'space-between'}}>
        <div className="date-cell-title" style={props.cellSelected ? {color: '#0F4DA9'} : {}}>{formatDate(props.day.date)}</div>
